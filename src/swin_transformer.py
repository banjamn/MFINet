...
import math
import sys
sys.path.append('/home/cuifengyu/Instance/1GeminiFusion-main')
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix=None):
        ...
        """
        B,C,self.H,self.W=x[0].shape
        x[0]=x[0].view(B,C,self.H*self.W).permute(0,2,1)
        x[1]=x[1].view(B,C,self.H*self.W).permute(0,2,1)
        B, L, C = x[0].shape
        H, W = self.H, self.W
